...
plot([i-0.4 i+0.4], [EP_NEP_amazon_annual_mean_beta EP_NEP_amazon_annual_mean_beta]/1000,...
    '-', 'LineWidth',3, 'Color','k')
set(gca, 'YLim',[-500 500]/1000, 'FontSize',8, 'YDir','reverse');
plot([0 15],[0 0],'k-')
...
plot([i-0.4 i+0.4], [CP_NEP_amazon_annual_mean_beta CP_NEP_amazon_annual_mean_beta]/1000,...
    '-', 'LineWidth',3, 'Color','k')
set(gca, 'YLim',[-500 500]/1000, 'YDir','reverse');
plot([0 15],[0 0],'k-')
ylb = ylabel('Pg C yr^{-1}', 'FontSize',8);
ylb.Position = [16.8    0.0000   -1.0000];
...
set(h, 'currentaxes',ax7);
i = 4.25;
plot([i-0.4 i+0.4], -1*[-0.16 -0.16],...
    '-', 'LineWidth',2, 'Color',clr2(1,:));
text(i+0.5, -1*-0.16, 'CAMS v15r2', 'Color',clr2(1,:), 'FontWeight','bold', 'FontSize',8,...
    'VerticalAlignment','middle', 'HorizontalAlignment','left')
plot([i-0.4 i+0.4], -1*[-0.12 -0.12],...
    '-', 'LineWidth',2, 'Color',clr2(2,:))
text(i+0.5, -1*-0.12, 'CAMS v15r4', 'Color',clr2(2,:), 'FontWeight','bold', 'FontSize',8,...
    'VerticalAlignment','middle', 'HorizontalAlignment','left')
i = 9.5;
plot([i-0.4 i+0.4], -1*[-0.16 -0.16],...
    '-', 'LineWidth',2, 'Color',clr2(3,:));
text(i+0.5, -1*-0.16, 'MACC v13r1', 'Color',clr2(3,:), 'FontWeight','bold', 'FontSize',8,...
    'VerticalAlignment','middle', 'HorizontalAlignment','left')
plot([i-0.4 i+0.4], -1*[-0.12 -0.12],...
    '-', 'LineWidth',2, 'Color',clr2(4,:))
text(i+0.5, -1*-0.12, 'MACC v14r2', 'Color',clr2(4,:), 'FontWeight','bold', 'FontSize',8,...
    'VerticalAlignment','middle', 'HorizontalAlignment','left')

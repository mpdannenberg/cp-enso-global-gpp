...
temp_tropics_monthly = NaN(nt, 12, nm);
...
EP_GPP_tropics_monthly_beta_CI = NaN(12, length(models));
...
for i = 1:12
    ...
    for j = 1:length(models)
        ...
        if i == 1
            ...
            disp(['Global tropics ',models{j},' response to EPI (PgC yr-1): ',...
                num2str(round(mdl.Coefficients.Estimate(2)/1000,2)),' +/- ',...
                num2str(round(1.96*mdl.Coefficients.SE(2)/1000,2))]);
        end
    end
...
CP_GPP_tropics_monthly_beta_CI = NaN(12, length(models));
...
for i = 1:12
    ...
    for j = 1:length(models)
        ...
        if i == 1
            ...
            disp(['Global tropics ',models{j},' response to CPI (PgC yr-1): ',...
                num2str(round(mdl.Coefficients.Estimate(2)/1000,2)),' +/- ',...
                num2str(round(1.96*mdl.Coefficients.SE(2)/1000,2))]);
        end
    end
